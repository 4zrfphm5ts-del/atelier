/* Au Soleil — service worker (hors ligne). Actif uniquement en https.
 *
...
const CORE = ["./", "./index.html", "./manifest.webmanifest",
  // data.js (les 209 terrasses) et Leaflet : sans eux la page hors ligne
  // s'ouvre vide. Ils ne changent qu'à une regénération, cache d'abord.
  "./data.js", "./leaflet-1.9.4.js", "./leaflet-1.9.4.css",
  "./icon-180.png", "./icon-192.png", "./icon-512.png", "./favicon-32.png"];

/* Terrasse, réseau à une barre : on n'attend pas la fin des temps. */
...
function horsService() {
  return new Response(
    ...
    "justify-content:center;background:#0f1419;color:#f4efe6;" +
    "font:16px/1.6 system-ui,sans-serif;text-align:center;padding:32px\">" +
    "<div><p style=\"font-size:2rem;margin:0 0 12px\">☀️</p>" +
    "<p>Pas de réseau, et plus rien en mémoire.</p>" +
    "<p style=\"color:#9aa7b4\">Reconnecte-toi une fois : l'app se réinstalle toute seule.</p>" +
    "</div>",
